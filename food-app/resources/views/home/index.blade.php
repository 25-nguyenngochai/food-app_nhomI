        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="featured__controls">
                    <ul>
                        <li onclick="location.href='{{url('/index')}}';">All</li>
                        @foreach($allCategory as $value)
                        <li onclick="location.href='{{url('/index')}}?category_id={{$value->id}}';">
                            {{$value->name}}
                        </li>
                        @endforeach
                    </ul>
                ...
                <div class="col-lg-3">
                    <div class="product__discount__item">
                        <div class="product__discount__item__pic set-bg"
                            data-setbg="{{asset('images/'.$value->image)}}">
                            <ul class="product__item__pic__hover">
                                @php $countWishlist = 0 @endphp
                                @if(Auth::check())
                                @php $countWishlist = App\Models\Wishlist::countWishlist($value['id']) @endphp
                                ...
                                <li><a href="{{url('login')}}"><i class="fa fa-heart"></i></a></li>
                                @endif
                                <li><a href="{{route('addCart', $value->id)}}"><i class="fa fa-shopping-cart"></i></a>
                                </li>
                            </ul>
                        </div>
                        <div class="product__discount__item__text">
...
<div class="clear" style="padding-top: 80px;"></div>
<!-- Banner End -->
